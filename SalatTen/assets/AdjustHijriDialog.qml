...
FullScreenDialog
{
    ...
    onOpened: {
        ...
        tutorial.exec("hijriExit", qsTr("Tap anywhere outside the controls to dismiss this dialog."), HorizontalAlignment.Center, VerticalAlignment.Bottom, 0, 0, 0, tutorial.du(4));
    }
