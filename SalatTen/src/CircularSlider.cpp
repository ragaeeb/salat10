    ...
    , m_value(0)
{
    ...
    m_trackImage = ImageView::create().image(QUrl("asset:///images/slider/slider_track.png"));
    ...
    m_handleOn = Image(QUrl("asset:///images/slider/handle_pressed.png"));
    m_handleOff = Image(QUrl("asset:///images/slider/handle_inactive.png"));
...
void CircularSlider::onSliderHandleTouched(TouchEvent* touchEvent)
{
    ...
    } else if ( touchEvent->isUp() || touchEvent->isCancel() ) {
